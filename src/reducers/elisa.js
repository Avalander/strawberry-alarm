...
export const elisaReducer = ({ elisa_running=initElisaRunning(), elisa_idle=initElisaIdle(), elisa_attacking=initElisaAttacking(), elisa_jumping=initElisaJumping(), elisa_wounded=initElisaWounded() }, [{ player, camera }]) => {
	...
	return { elisa_idle, elisa_running, elisa_attacking, elisa_jumping, elisa_wounded }
}